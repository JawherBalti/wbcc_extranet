<?php
/**
 * Script pour la gestion des rendez-vous (RDV) dans le formulaire
 * Gère l'affichage et fonctionnalités liées aux prises de RDV
 */
?>
<script>
...
// Gestion disponibilité premier RDV
