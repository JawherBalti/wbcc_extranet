                                    ...
                                    <div class="col-md-12 mx-3">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <input type="text" id="nomDocument" name="nomDocument" class="form-control">
                                            </div>


                                            <div class="col-md-6 mb-3">
                                                <label for="commentsDemande">Commentaire</label>
            ...
            document.addEventListener('DOMContentLoaded', function () {
                ...
                $(document).ready(function () {
                    $('#leaveRequestForm').on('submit', function (event) {
                        ...
                        formData.append('motif', plainText); // Ajoute la justification à FormData
                        formData.append('nomDocument', ["nomDocument"]); // Ajoute la justification à FormData
                        formData.append('comments', ["comments"]); // Ajoute la justification à FormData
