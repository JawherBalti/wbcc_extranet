...
$viewAdmin = (($idRole == "1" || $idRole == "2" || $idRole == "25")) ? "" : "hidden";
        ...
        <div class="card accordion-item" style="border-radius: none !important; box-shadow: none !important;">
            ...
            <div id="bloc1" class="accordion-collapse collapse show" data-bs-parent="#accordionFiltrea"
                ...
                <div class="accordion-body" style="box-shadow: none !important;">
                    <form method="GET" action="<?= linkTo('GestionInterne', 'gerepresence') ?>"
                        style="border: none; margin: 0 !important; padding: 0 !important;margin: auto;">
                        <div class="row" style="width: 100%;  margin: auto;">

                            <div class="<?= $viewAdmin2 != "" ? "hidden" : "col-md-2 col-xs-12" ?> ">
                                <fieldset>
                                    <legend
                                ...
                                <fieldset>
                                    ...
                                    <select id="site" name="site" class="form-control">
                                        ...
                                        foreach ($sites as $sit) {
                                            if ((($idRole == "1" || $idRole == "2") || (($idRole != "1" && $idRole != "2") && $_SESSION["connectedUser"]->idSiteF == $sit->idSite))) {
                                        ?>
                            ...
                            <div class="<?= $viewAdmin2 != "" ? "col-md-4" : "col-md-2" ?>  col-xs-12 mb-3">
                                <fieldset>
                                    <legend
                                        class='text-white col-md-12 text-uppercase font-weight-bold text-center py-2 badge bg-dark mx-0'>
                                        Statut d'arrivée
                                    ...
                                    <div class="card ">
                                        <select id="etat" name="etat" class="form-control">
                                            ...
                                            <option <?= $etat === 'Present' ? 'selected' : '' ?> value="Present">À
                                                l'heure</option>
                                            <option <?= $etat === 'Retard' ? 'selected' : '' ?> value="Retard">Retard
                                            </option>
                                            <option <?= $etat === 'Absent' ? 'selected' : '' ?> value="Absent">Absent
                                            </option>
                                        </select>
                                    </div>
                                </fieldset>
                                ...
                                <fieldset>
                                    ...
                                    <div class="card ">
                                        <select id="Motifjustification" name="Motifjustification" class="form-control">
                                            <option <?= $Motifjustification === '' ? 'selected' : '' ?> value="">
                                                Tout
                                            </option>
                                            <option <?= $Motifjustification === 'justifie' ? 'selected' : '' ?>
                                                value="justifie">Justifié</option>
                                            <option <?= $Motifjustification === 'injustifie' ? 'selected' : '' ?>
                                                value="injustifie">Injustifié</option>
                                            <option <?= $Motifjustification === 'non-traite' ? 'selected' : '' ?>
                                                value="non-traite">Non traité</option>
                                        </select>
                                    </div>
                                </fieldset>
                            </div>
            ...
            <table id="dataTable16" class="table table-bordered" width="100%" cellspacing="0">
                <thead class="thead">
                    <tr>
                        ...
                        <th>Actions</th>
                        <th>Date</th>
                        <th class="<?= $viewAdmin2 ?> ">Nom</th>
                        <th bgcolor="<?= $color1 ?>">Heure Début</th>
                        <th bgcolor="<?= $color1 ?>">Heure d'arrivée</th>
                        <th bgcolor="<?= $color1 ?>">Statut d'arrivée</th>
                        <th bgcolor="<?= $color1 ?>">Nb Min. Retard</th>
                        <th bgcolor="<?= $color1 ?>">Justif. d'arrivée</th>
                        <th bgcolor="<?= $color1 ?>">Mention d'arrivée</th>
                        <th bgcolor="<?= $color2 ?>">Heure Fin</th>
                        <th bgcolor="<?= $color2 ?>">Heure de Départ</th>
                        <th bgcolor="<?= $color2 ?>">Statut de départ</th>
                        <th bgcolor="<?= $color2 ?>">Nb Min. départ</th>
                        <th bgcolor="<?= $color2 ?>">Justif. Départ</th>
                        <th bgcolor="<?= $color2 ?>">Mention Départ</th>
                        <th bgcolor="<?= $color3 ?>">Justif. d'absence</th>
                        <th bgcolor="<?= $color3 ?>">Mention d'absence</th>
                    </tr>
                </thead>
                <tbody>
                    <?php foreach ($pointageListe as $index => $pointage): ?>
                        ...
                        ?>
                        <tr data-id="<?= isset($pointage->idPointage) ? $pointage->idPointage : '' ?>"
                            ...
                            <td class="text-center">
                                <button type="button" class="btn btn-sm btn-icon ml-2"
                                    onclick="showPointageDetails(<?= isset($pointage->idPointage) ? $pointage->idPointage : '0' ?>)"
                            ...
                            <td bgcolor="<?= $color1 ?>">
                                <?= $pointage->heureDebutJour !== null ? $pointage->heureDebutJour : '-' ?></td>

                            <td bgcolor="<?= $color1 ?>"><?= $pointage->heureDebutPointage ?? '-'; ?></td>

                            <td bgcolor="<?= $color1 ?>"><?= $etat ?></td>
                            ...
                            <td bgcolor="<?= $color1 ?>">
                                ...
                                if ($pointage->absent === 0 && $pointage->retard === 0) {
                                    ...
                                    if ($pointage->retard == "1") {
                                        echo '<span class="badge badge-error">Non Traité</span>';
                                    } else {
                                        echo '-';
                                    }
                                }
                            ...
                            <td bgcolor="<?= $color2 ?>">
                                <?= $pointage->heureFinJour !== null ? $pointage->heureFinJour : '-' ?></td>

                            <td bgcolor="<?= $color2 ?>">
                                <?= $pointage->heureFinPointage !== null ? $pointage->heureFinPointage : '-' ?></td>

                            <td bgcolor="<?= $color2 ?>"><?= $etatdepart ?></td>

                            <td bgcolor="<?= $color2 ?>">
                                <?= $pointage->heureFinPointage == null ? '-' : calculerDifferenceHeures($pointage->heureFinJour, $pointage->heureFinPointage) ?>
                            </td>
                            <td bgcolor="<?= $color2 ?>">
                                <?php
                                if (
...
<div class="modal fade" id="detaillePointageModal" tabindex="-1" role="dialog" aria-labelledby="modalLabel"
    aria-hidden="true">
            ...
            <div class="modal-body px-4 py-4">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <p><i class="fas fa-id-badge"></i> <strong>Matricule:</strong> <span id="modalmatricule"></span>
                        </p>
                    ...
                    <div class="col-md-6">
                        <p><i class="fas fa-clock"></i> <strong>Heure Début:</strong> <span
                                id="modalHeureDebutJour"></span></p>
                        <p><i class="fas fa-clock"></i> <strong>Heure d'arrivée:</strong> <span
                                id="modalHeureDebutPointage"></span></p>

                        <p><i class="fas fa-hourglass-half"></i> <strong>Nb Min de Retard:</strong> <span
                                id="modalMinutesRetard"></span></p>
                        <p><i class="fas fa-clock"></i> <strong>Heure Fin:</strong> <span id="modalHeurefinJour"></span>
                        </p>
                        <p><i class="fas fa-clock"></i> <strong>Heure de Départ:</strong> <span
                                id="modalHeurefinPointage"></span></p>

                        <p><i class="fas fa-hourglass-half"></i> <strong>Nombre de min du départ:</strong> <span
                                id="modalminutesDepart"></span></p>
                    </div>
                </div>
                <hr>
                ...
                <div class="arrivee-section">
                    <p><i class="fas fa-comment"></i> <strong>Mention d'arrivée:</strong> <span
                            id="modalMotifRetard"></span></p>
                    <p>
                    ...
                    <div class="mt-0">
                        <div class="<?= $viewAdmin != '' ? $viewAdmin : 'form-group confirm-justif-depart' ?>">
                            <label for="confirmationDepart" class="font-weight-bold">Êtes-vous sûr de vouloir valider la
                                justification du départ?</label><br>
...
<div class="modal fade" id="confirmJustificationModal" tabindex="-1" role="dialog" aria-labelledby="modalLabel" aria-hidden="true">
    ...
    <div class="modal fade" id="notificationModal" tabindex="-1" role="dialog" aria-labelledby="notificationModalLabel"
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content shadow-lg rounded">
                <div class="modal-header bg-danger text-white">
                    <h5 class="modal-title font-weight-bold text-uppercase" id="notificationModalLabel">Notifications
                    </h5>
                    <button class="close text-white" type="button" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
    ...
    <script>
        ...
        $('#confirmJustificationArriveeSubmit').on('click', function() {
            ...
            if (confirmOui || confirmNon) {
                ...
                notificationTosend =
                    `Votre justificatif d'arrivée pour le ${datePointage} a été ${confirmation === "oui" ? "approuvé" : "rejeté"} par votre manager.`;
        ...
        $('#confirmJustificationAbsenceSubmit').on('click', function() {
            ...
            if (confirmDepartOui || confirmDepartNon) {
                ...
                titleNotificationToSend = `Justificatif ${confirmationDepart === "oui" ? "accepté" : "refusé"}`;
                notificationTosend =
                    `Votre justificatif de départ pour le ${datePointage} a été ${confirmationDepart === "oui" ? "approuvé" : "rejeté"} par votre manager.`;
                emailSubject = `Justification ${confirmationDepart === "oui" ? "Acceptée" : "Rejetée"}`;
                emailBody = `
        Bonjour,<br /><br />
        Votre manager a ${confirmationDepart === "oui" ? "accepté" : "rejeté"} le justificatif que vous avez soumis pour le ${datePointage}.<br /><br />
        ...
        async function getManagerId() {
            try {
                ...
                if (response.ok && Array.isArray(data) && data.length > 0) {
                    ...
                    console.error("Erreur lors de la récupération de l'ID du manager :", data.error ||
                        "Erreur inconnue");
                    return null;
                }
            } catch (error) {
        ...
        async function handleJustificationFormSubmit(formId, justificationType, motifSelector, documentSelector,
            commentSelector, motifErrorSelector) {
            $(`#${formId}`).on('submit', async function(event) {
                ...
                try {
                    ...
                    const response = await $.ajax({
                        url: `${URLROOT}/public/json/pointage.php?action=saveJustification2`,
                        type: 'POST',
                        data: formData,
                        dataType: 'json',
                        contentType: false,
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            $(document).ready(function() {
                // Call the function for all form submissions
                handleJustificationFormSubmit(
                    'justificationFormDepart',
                    'Départs',
                    '#motif-depart',
                    '#nomDocumentDepart',
                    '#commentaireDepart',
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    if (response.absent == 1) {
                        ...
                        if (calculerDifferenceHeures(response.heureFinJour, response.heureFinPointage)
                            .startsWith("+") ||
                            calculerDifferenceHeures(response.heureFinJour, response.heureFinPointage)
                            .startsWith("0") ||
                        ...
                        if (calculerDifferenceHeures(response.heureDebutJour, response.heureDebutPointage)
                            .startsWith("-")) {
                            arriveeSection.classList.add("hidden")
                    ...
                    if (response.resultatTraiteAbsent === 'Refusé') {
                        ...
                        resultatTraiteAbsentText = 'Injustifié';
                        badgeAbsentClass =
                            'badge-error'; // Classe par défaut si aucune des conditions n'est remplie
                    }

                    // Affichage dans l'élément HTML avec le badge
                    document.getElementById('modalMotifAbsence').innerHTML =
                        `<span class="badge ${badgeAbsentClass}">${resultatTraiteAbsentText}</span>`;
                    ...
                    if (confirmJustifAbsence) {
                        if (response.resultatTraiteAbsent === 'Accepté') {
                            ...
                            confirmJustifAbsenceMsg.innerHTML =
                                `Absence a été validé par ${response.auteurTraiteAbsent}`
                        } else if (response.resultatTraiteAbsent === 'Refusé') {
                            confirmJustifAbsence.classList.add('hidden')
                            confirmJustifAbsenceMsg.classList.remove("hidden")
                            confirmJustifAbsenceMsg.innerHTML =
                                `Absence n'a pas été validé par ${response.auteurTraiteAbsent}`
                        } else {
                    ...
                    if (confirmJustifArrivee) {
                        if (response.resultatTraite === 'Accepté') {
                            ...
                            confirmJustifArriveeMsg.innerHTML =
                                `Retard d'arrivée a été validé par ${response.auteurTraite}`
                        } else if (response.resultatTraite === 'Refusé') {
                            confirmJustifArrivee.classList.add('hidden')
                            confirmJustifArriveeMsg.classList.remove("hidden")
                            confirmJustifArriveeMsg.innerHTML =
                                `Retard d'arrivée n'a pas été validé par ${response.auteurTraite}`
                        } else {
                    ...
                    if (confirmJustifDepart) {
                        if (response.resultatTraiteDepart === 'Accepté') {
                            ...
                            confirmJustifDepartMsg.innerHTML =
                                `Retard de depart a été validé par ${response.auteurTraiteDepart}`
                        } else if (response.resultatTraiteDepart === 'Refusé') {
                            confirmJustifDepart.classList.add('hidden')
                            confirmJustifDepartMsg.classList.remove("hidden")
                            confirmJustifDepartMsg.innerHTML =
                                `Retard de depart n'a pas été validé par ${response.auteurTraiteDepart}`
                        } else {
                    ...
                    if (datePointageElement) {
                        datePointageElement.innerText = formatDate2(response.datePointage) || '-';
                    }
                    ...
                    if (minutesDepartElement) {
                        minutesDepartElement.innerText = calculerDifferenceHeures(response.heureFinJour,
                            response.heureFinPointage);
                    }
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function updateTable(data) {
                ...
                data.forEach((item, index) => {
                    ...
                    <td>${formatDate2(item.datePointage)}</td>
                    <td>${item.fullName || '-'}</td>
                    ...
                    <td>${item.absent === 0 && item.retard === 0
                    ...
                    <td>${item.absent === 1 || calculerDifferenceHeures(item.heureFinJour, item.heureFinPointage) === '-'
                            ? '-' // Absent ou à l'heure
