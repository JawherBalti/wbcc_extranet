<?php
/**
 * Gestion des interactions de formulaire B2C
 * Fonctions pour les radios, checkboxes et champs conditionnels
 */
?>
<script>
// Gestion des références multiples (partagé avec B2B)
refs.forEach(ref => {
