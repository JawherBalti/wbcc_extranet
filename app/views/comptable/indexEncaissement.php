        ...
        <div class="accordion-body pt-3 pb-3 pr-3" style="box-shadow: none !important;">
            <form method="GET" action="<?= linkTo('Comptable', 'indexEncaissement', "") ?>">
                <div class="row" style="width: 100%;  margin: auto;">
                    <div class="<?= $viewAdmin2 != "" ? "col-md-4" : "col-md-3"  ?>">
                        <fieldset>
                            <legend
                            ...
                            <div class="card ">
                                <select id="statut" name="statut" class="form-control" data-live-search="true">
                                    <option value="0" disabled selected>--Choisir une catégorie d'OP--</option>
                                    <option value="tous" <?= $statut == "tous" ? "selected" : "" ?>>- Toutes les
                                        opportunités
                                    </option>
                                    <option value="AMO" <?= $statut == "AMO" ? "selected" : "" ?>>- A.M.O.</option>
                                    <option value="SINISTRE" <?= $statut == "SINISTRE" ? "selected" : "" ?>>- Sinistres
                                    </option>
                                    <option value="enCours" <?= $statut == "enCours" ? "selected" : "" ?>>- Les
                                        opportunités
                                        en cours de
                                        gestion</option>
                                    <option value="clotures" <?= $statut == "clotures" ? "selected" : "" ?>>- Les
                                        opportunités
                                        clôturées
                                    </option>
                                </select>
                    ...
                    <div class=" <?= $viewAdmin2 != "" ? "col-md-4" : "col-md-3" ?>">
                        <fieldset>
                            <legend
                                ...
                                site </legend>
                            <div class="card ">
                                <select id="typeOpSelected" name="type" class="form-control" data-live-search="true">
                                    <option value="0" disabled selected>--Choisir un type OP--</option>
                                    <option value="me" <?= $type == "me" ? "selected" : "" ?>> Mes Opportunités</option>
                                    ...
                                    ?>
                                            <option <?= $type == $sit->idSite ? "selected" : "" ?> value="<?= $sit->idSite ?>">
                                                <?= "Les opportunités du site " . $sit->nomSite ?></option>
                                    <?php
                                        }
                                    } ?>
                                </select>
                        ...
                        <fieldset>
                            ...
                            <div class="card">
                                <select id="gestionnaireSelected" name="gestionnaire" class="form-control"
                                    ...
                                    <option value="0" disabled selected>--Choisir un gestionnaire--</option>
